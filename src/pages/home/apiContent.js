...
import ApiImg1 from "../../images/image28.png";
import ApiImg2 from "../../images/Group353.png";
import ApiImg3 from "../../images/api3.svg";
import ApiImg4 from "../../images/image29.svg";
const ApiSection = () => {
  return (
    <div className="container api-section">
      ...
      <div className="api-content flex-normal">
        <div className="api-content-detail mr-90">
          ...
          <p>
            CurrikiStudio is designed to help organizations transform curriculum
            into what drives learner engagement. With a wide library of diverse
            activity types and the ability to completely customize the brand
            experience and publishing destinations, CurrikiStudio is the best
            all-in-one solution for building the next generation of learning
            experiences.
          </p>
